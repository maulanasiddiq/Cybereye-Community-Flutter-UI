...
class DetailTot extends StatefulWidget {
  @override
  _DetailTotState createState() => _DetailTotState();
}

class _DetailTotState extends State<DetailTot> {
  @override
